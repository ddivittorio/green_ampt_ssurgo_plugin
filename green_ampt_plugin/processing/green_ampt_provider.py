...
from green_ampt_plugin.processing import algorithms
from green_ampt_plugin.processing.green_ampt_algorithm import (
    GreenAmptAlgorithm,
)
...
class GreenAmptProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        alg_classes = [
            ...
            if issubclass(m[1], GreenAmptAlgorithm) and m[1] != GreenAmptAlgorithm
        ]
