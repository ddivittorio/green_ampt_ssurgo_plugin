...
- Use the [GitHub Issues](https://github.com/ddivittorio/qgis_green_ampt_plugin_jules/issues) tracker
...
1. **Fork the Repository**
   ```bash
   git clone --recursive https://github.com/YOUR_USERNAME/qgis_green_ampt_plugin_jules.git
...
Check the [Issues](https://github.com/ddivittorio/qgis_green_ampt_plugin_jules/issues) page for:
- Known bugs
- Feature requests
- Enhancement ideas
...
- Open a [GitHub Discussion](https://github.com/ddivittorio/qgis_green_ampt_plugin_jules/discussions)
