...
1. **Batch Processing**: Built-in support for multiple AOIs
2. **Advanced Options**: More granular control over processing
3. **Custom Lookup Tables**: User-provided parameter tables
4. **Output Styling**: Pre-configured color ramps for parameters
5. **Processing Models**: Example models for common workflows
6. **Unit Tests**: Automated testing of algorithm logic
...
1. Update `green_ampt_plugin/metadata.txt`:
   ...
   - Add changelog entry
2. Tag release: `git tag -a v1.0 -m "Release 1.0"`
3. Push: `git push origin v1.0`
4. Create GitHub release
5. Package: `zip -r green_ampt_plugin_v1.0.zip green_ampt_plugin/`
...
- **Author**: Damien Di Vittorio
- **Email**: damien.divittorio@gmail.com
- **Repository**: https://github.com/ddivittorio/green_ampt_ssurgo_plugin
