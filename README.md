...
1. **Download the Plugin Package:**
   - Download the latest `green_ampt_plugin_v{VERSION}.zip` from the [Releases page](https://github.com/ddivittorio/green_ampt_ssurgo_plugin/releases)
...
1. **Download or Clone this Repository:**
   ```bash
   git clone --recursive https://github.com/ddivittorio/green_ampt_ssurgo_plugin.git
...
```bibtex
@software{divittorio2025greenampt,
  author = {Damien Di Vittorio},
  title = {QGIS Green-Ampt Plugin},
  year = {2025},
```
...
- **Issues**: [GitHub Issues](https://github.com/ddivittorio/green_ampt_ssurgo_plugin/issues)
